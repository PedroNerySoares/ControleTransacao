...
public class AlterarPasswordUsuarioDto {
    private String email;
    private String antigaSenha;
    private String novaSenha;


    public AlterarPasswordUsuarioDto(){}
    public AlterarPasswordUsuarioDto(String email, String antigaSenha, String novaSenha) {
        this.email = email;
